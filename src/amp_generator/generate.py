...
def download_large_weights():
    ...
    files_to_download = {
        ...
        ROOT_DIR / "acp_feature_comparison_results/models/acp_classifier_aac_dde.joblib": "18YVSQzb30FGMHed1rRJGydhf301-yTBI",
        ROOT_DIR / "acp_feature_comparison_results/models/hemolysis_classifier.joblib": "185AXy2Qyy_mYhKlyN35NcDkSQd3s9xl1",
